...
listbox = Listbox(window,height=10,widht=39,activestyle='dotbox',bg='LightSkyBlue',borderwidth=2,font=("Calibri",10))
...
Download = Button(window,text="Download",width=10,bd=1,bg='SkyBlue',font=("Claibri",10))
